...
## 3. Como fica um post na prática (a parte mais importante)

Montar o post é onde mora a maior dificuldade. Por isso, aqui está a estrutura e exemplos prontos, do jeitinho que aparecem no Instagram. Você pode copiar esse molde sozinho ou pedir ao Claude que monte igual.

**A anatomia de um bom post:**
1. Uma imagem que para o dedo (produto bonito, luz natural, fundo limpo).
2. A primeira linha que fisga (o gancho, aparece antes do "... mais").
3. Um corpo curto, uma ideia por linha.
4. Um único CTA (o que fazer agora).
5. Hashtags no fim ou no primeiro comentário.
...
- Emoji com moderação, como toque de carinho no início ou no fim da linha.
- Nada de negrito, itálico ou cor no texto: o Instagram não tem isso.
